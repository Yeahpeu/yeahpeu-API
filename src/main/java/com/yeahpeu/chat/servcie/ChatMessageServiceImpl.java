...
public class ChatMessageServiceImpl implements ChatMessageService {
    ...
    public ChatRoomMessageDTO sendMessage(SendMessageCommand command) {
        ...
        ChatRoomMessageCounter chatRoomMessageCounter = chatMessageCounterRepository.findByRoomIdWithLock(command.getRoomId())
        ...
        newMessage.setSentAt(command.getSentAt());
